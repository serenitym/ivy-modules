   ...
   */
    ...
    */
    ...
    function GET_priorities(&$query_origin, &$where)         {
        ...
        * */
        ...
        $this->C->GETconf($this,incPath.'etc/MODELS/blog/blog_HomePriorities.yml' );
    ...
    function SET_queryRecords(&$query, &$where) {
     #==============================================================================================================
    ...
    function GET_Records()                      {
        ...
        */
        ...
        # 1
        $query = $where = '';
        $this->SET_queryRecords($query, $where);
        ...
        $query .=  $where." ORDER BY entryDate DESC LIMIT {$this->LimitStart},{$this->nrRecords}" ;

        #===============================================================================================================

        # 4
        $this->records = $this->C->GET_objProperties($this, $query, 'ProcessRecords');
    ...
    */
    ...
    function setINI()              {
        ...
        isset($_GET['idRec']) ? $this->GET_Record() :  $this->GET_Records();     # daca s-a facut un request de record

        #===============================================================================================================
        if(!isset($this->uid)) echo 'Nici un user nu a fost setat '."</br>";
